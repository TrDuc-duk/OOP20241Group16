...
public class Content {
	...
	public static BufferedImage[][] Explosion = load("/Sprites/Enemies/Explosion.gif", 34, 31);
	public static BufferedImage[][] RedGem = load("/Sprites/Enemies/RedGem.gif", 20, 16);
	public static BufferedImage[][] BlueGem = load("/Sprites/Enemies/BlueGem.gif", 20,16 );
	public static BufferedImage[][] BrownGem = load("/Sprites/Enemies/BrownGem.gif", 20, 16);
	public static BufferedImage[][] GreyGem = load("/Sprites/Enemies/GreyGem.gif", 20, 16);
	...
	public static BufferedImage[][] Captain = load("/Sprites/Enemies/Captain.gif", 35 , 26);
